---
name: "source-command-bmad-bmm-retrospective"
description: "Post-epic review to extract lessons and assess success. Use when the user says \"run a retrospective\" or \"lets retro the epic [epic]\""
---

# source-command-bmad-bmm-retrospective

Use this skill when the user asks to run the migrated source command `bmad-bmm-retrospective`.
