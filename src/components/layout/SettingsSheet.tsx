...
export function SettingsSheet({ onClose, onOpenRoadmap, onOpenAbout, onOpenRepoSettings }: SettingsSheetProps) {
  return (
    <BottomSheet
      onClose={onClose}
      ariaLabel="Settings"
