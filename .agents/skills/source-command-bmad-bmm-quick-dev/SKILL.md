---
name: "source-command-bmad-bmm-quick-dev"
...
# source-command-bmad-bmm-quick-dev

Use this skill when the user asks to run the migrated source command `bmad-bmm-quick-dev`.
