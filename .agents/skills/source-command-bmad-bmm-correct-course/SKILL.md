---
name: "source-command-bmad-bmm-correct-course"
description: "Manage significant changes during sprint execution. Use when the user says \"correct course\" or \"propose sprint change\""
---

# source-command-bmad-bmm-correct-course

Use this skill when the user asks to run the migrated source command `bmad-bmm-correct-course`.
