---
name: "source-command-bmad-bmm-qa-generate-e2e-tests"
description: "Generate end to end automated tests for existing features. Use when the user says \"create qa automated tests for [feature]\""
---

# source-command-bmad-bmm-qa-generate-e2e-tests

Use this skill when the user asks to run the migrated source command `bmad-bmm-qa-generate-e2e-tests`.
