---
name: "source-command-bmad-bmm-document-project"
description: "Document brownfield projects for AI context. Use when the user says \"document this project\" or \"generate project docs\""
---

# source-command-bmad-bmm-document-project

Use this skill when the user asks to run the migrated source command `bmad-bmm-document-project`.
