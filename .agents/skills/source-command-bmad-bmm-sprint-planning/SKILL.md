---
name: "source-command-bmad-bmm-sprint-planning"
description: "Generate sprint status tracking from epics. Use when the user says \"run sprint planning\" or \"generate sprint plan\""
---

# source-command-bmad-bmm-sprint-planning

Use this skill when the user asks to run the migrated source command `bmad-bmm-sprint-planning`.
