---
name: "source-command-bmad-bmm-code-review"
...
# source-command-bmad-bmm-code-review

Use this skill when the user asks to run the migrated source command `bmad-bmm-code-review`.
