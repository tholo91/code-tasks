...
- [ ] **Change the ai agent instruction** ([Created: 2026-03-17]) (Priority: ⚪ Normal)
  The ai agent working with this captured-ideas.md should know that he can check off tasks that he has finished and add to their description "checked by Claude/Gemini)

- [ ] **List view scrolling** ([Created: 2026-03-17]) (Priority: 🔴 Important)
  I think one should always know, in what repository one is, so that should be stuck/visible with a nice UI at the top

- [ ] **Bottom sheet** ([Created: 2026-03-17]) (Priority: ⚪ Normal)
  Clicking outside of a bottom sheet should close it (so save a task as it is right now or about the switch of repository). Makes sense?
...
- [ ] **List View UI** ([Created: 2026-03-17]) (Priority: 🔴 Important) [Updated: 2026-03-17]
  Find Ich gut, sollte aber näher an Things sein / Screenshots oder pencil.dev?
One should see which tasks are important in a way - maybe with an emoji? Or how?)
...
- [ ] **Slide to delete fix** ([Created: 2026-03-17]) (Priority: 🔴 Important) [Updated: 2026-03-17]
  It looks a bit off. Maybe let's hide that for now and only show the "delete task" only in a detail view

- [ ] **UI improvements** ([Created: 2026-03-17]) (Priority: ⚪ Normal)
  When clicking enter In the description, it should jump to the description field
