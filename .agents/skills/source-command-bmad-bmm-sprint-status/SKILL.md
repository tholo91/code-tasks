---
name: "source-command-bmad-bmm-sprint-status"
description: "Summarize sprint status and surface risks. Use when the user says \"check sprint status\" or \"show sprint status\""
---

# source-command-bmad-bmm-sprint-status

Use this skill when the user asks to run the migrated source command `bmad-bmm-sprint-status`.
