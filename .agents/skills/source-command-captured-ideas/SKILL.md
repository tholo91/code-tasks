---
name: "source-command-captured-ideas"
description: "List unprocessed captures from this repo's captured-ideas-*.md file across all branches, grouped by priority"
---

# source-command-captured-ideas

Use this skill when the user asks to run the migrated source command `captured-ideas`.
...
Then point the user to the README section "Using Gitty with Codex" for how to connect a repo, and stop.
...
- `.Codex/skills/superpowers*` → **Superpowers**
